...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'BRUNOMATSOLO'
...
def usuarios():
    if logado == True:
        arquivo = []
        for documento in os.listdir('../site_bruno_rezende/arquivos'):
...
def upload():
    ...
    arquivo.save(os.path.join('../site_bruno_rezende/arquivos/', nome_arquivo))
